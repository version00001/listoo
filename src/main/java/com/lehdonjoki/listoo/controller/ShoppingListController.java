...
public class ShoppingListController {
    ...
    @PostMapping
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ShoppingList> createList(Authentication authentication, @RequestBody Map<String, String> request) {
    ...
    @GetMapping("/{listId}")
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ShoppingList> getList(@PathVariable Long listId, Authentication authentication) {
    ...
    public ResponseEntity<ShoppingList> updateList(
        ...
        ShoppingList updatedList = shoppingListService.updateList(authentication.getName(), listId, newName);
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ShoppingList> archiveList(@PathVariable Long listId, Authentication authentication) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ShoppingList> restoreList(@PathVariable Long listId, Authentication authentication) {
