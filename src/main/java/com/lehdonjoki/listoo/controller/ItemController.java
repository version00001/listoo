...
public class ItemController {
    ...
    public ResponseEntity<List<Item>> getItemsInList(@PathVariable Long listId, Authentication authentication) {
    ...
    public ResponseEntity<Item> updateItem(
        ...
        Item updatedItem = itemService.updateItem(authentication.getName(), listId, itemId, newName, newQuantity);
