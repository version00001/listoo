...
public class UserController {
    ...
    @PutMapping("/me")
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<User> updateUserProfile(Authentication authentication, @RequestBody Map<String, String> request) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<User> updateUserPreferences(Authentication authentication, @RequestBody Map<String, String> preferences) {
