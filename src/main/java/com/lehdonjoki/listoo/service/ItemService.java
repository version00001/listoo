...
public class ItemService {
     ...
     */
    @Transactional
    public Item updateItem(String email, Long listId, Long itemId, String newName, Integer newQuantity) {
    ...
    private Item getItemInUserList(String email, Long listId, Long itemId) {
        ShoppingList list = getUserShoppingList(email, listId);
        return itemRepository.findByIdAndShoppingList(itemId, list)
